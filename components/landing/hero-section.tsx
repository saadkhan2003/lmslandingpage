  ...
  return (
    <section className="relative w-full overflow-hidden bg-black">
      ...
      <div className="relative sm:hidden">
        <div className="px-4 pt-10 pb-0">
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              <Badge
                variant="secondary"
                className="gap-1 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-xs text-white/80 backdrop-blur-sm"
              >
            ...
            <div className="flex w-full flex-col gap-3">
              <Button
                asChild
                className="h-12 w-full rounded-xl bg-red-600 px-6 text-sm font-semibold text-white shadow-[0_0_40px_-8px_rgb(220_38_38/0.8)] transition-all hover:-translate-y-0.5 hover:bg-red-500"
              >
                <Link href="/payment">
              ...
              <Button
                asChild
                variant="outline"
                className="h-12 w-full rounded-xl border-white/20 bg-white/5 px-6 text-sm font-semibold text-white backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:bg-white/10"
              >
                <Link href="#outline">
        ...
        {/* Mentor image on mobile - positioned at bottom */}
